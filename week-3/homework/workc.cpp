...
int main() {
    try {
        ...
        if (pid == 0) {
            ...
            std::cout << "Child process (PID: " << getpid() << ") found minimum in second half: " << min_second_half << std::endl;
            ...
            std::cout << "Parent process (PID: " << getpid() << ") found minimum in first half: " << min_first_half << std::endl;
